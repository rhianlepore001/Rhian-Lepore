...
export const Register: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen ${styles.bg} flex items-center justify-center p-4 relative overflow-hidden transition-colors duration-700`}>
      ...
      <div className={`w-full max-w-lg relative z-10 ${styles.cardBg} border-4 border-black shadow-heavy transition-colors duration-500`}>
