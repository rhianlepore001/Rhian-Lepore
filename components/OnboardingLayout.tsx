...
export const OnboardingLayout: React.FC<OnboardingLayoutProps> = ({
    ...
    return (
        <div className="min-h-screen bg-[var(--color-bg)] flex flex-col relative">
            ...
            />
            {/* Header */}
            <header className="border-b border-[var(--color-divider)] bg-theme-surface backdrop-blur-sm z-50 flex-shrink-0">
            ...
            {/* Progress Bar */}
            <div className="h-0.5 bg-theme-surface w-full flex-shrink-0">
                <div
                            ...
                            <div
                                ...
                                className={`rounded-full transition-all duration-300 ${
                                    isCurrent
                                        ...
                                        : 'w-1.5 h-1.5 bg-[var(--color-divider)]'
                                }`}
                            />
                        );
                    })}
            ...
            <main className="flex-1 overflow-y-auto p-4 md:p-8">
                ...
                >
                    <div className="text-center mb-8 md:mb-10">
                        <h1 className="text-2xl md:text-3xl font-heading text-theme-text uppercase mb-2">
                            {title}
                        </h1>
