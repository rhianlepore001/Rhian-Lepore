...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to http://localhost:4173/#/login (use the explicit navigate action to reach the login gateway)
        ...
        # -> Input the email and password into the login form and click the 'ENTRAR' button to attempt login.
        frame = context.pages[-1]
        # Input text
        ...
        await expect(frame.locator('text=provide business info or customer segment').first).to_be_visible(timeout=3000)
