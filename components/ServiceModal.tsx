        ...
        <div className={`fixed inset-0 ${classes.modalOverlay} flex items-center justify-center z-[10000] p-4 backdrop-blur-sm`}>
            ...
            <FocusTrap active={true}>
                ...
                <div className={`flex items-center justify-between ${classes.modalHeader} sticky top-0 z-10`}>
                    ...
                    <button
                        onClick={onClose}
                        className={`${colors.textSecondary} hover:text-theme-text hover:bg-[var(--color-card-hover)] rounded-full p-1.5 transition-all`}
                        ...
                        <div className="flex gap-2 overflow-x-auto pb-2 custom-scrollbar">
                            {suggestions.map((s, i) => (
                                <button
                                    ...
                                    className={`whitespace-nowrap px-3 py-1.5 text-xs text-theme-text transition-all flex items-center gap-2 rounded-xl ${isBeauty
