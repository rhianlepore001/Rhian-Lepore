...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to http://localhost:4173/#/login as the next immediate action.
        await page.goto("http://localhost:4173/#/login")
        
        # -> Click the 'Barbearia' option to proceed toward the login screen (index 112).
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div/div/button').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Fill the email (index 175) and password (index 181) fields and click the 'ENTRAR' login button (index 195).
        frame = context.pages[-1]
        # Input text
        ...
        # -> Click 'Clientes' in the main navigation (interactive element index 303).
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div/aside/nav/a[4]').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Click the 'Novo Cliente' button to open the add-client form/modal (index 782).
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div/main/div/div/div/button').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Fill the Nome Completo input (index 1024) with 'Test Client Searchable' as the immediate next action, then fill phone, submit, search, and verify client is visible.
        frame = context.pages[-1]
        # Input text
        ...
        frame = context.pages[-1]
        # Input text
        elem = frame.locator('xpath=/html/body/div/div/main/div/div/div[4]/div/form/div[2]/div/div/div/input').nth(0)
        ...
        # -> Type 'Test Client Searchable' into the client search field (index 786), wait for results, then extract page content to verify the client appears in the filtered list.
        frame = context.pages[-1]
        # Input text
