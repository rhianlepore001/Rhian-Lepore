...
export const MoreOptionsDrawer: React.FC<MoreOptionsDrawerProps> = ({ onClose }) => {
  ...
  const menuItems: MenuItem[] = [
    ...
    { name: 'Serviços', icon: Scissors, path: '/configuracoes/servicos', ownerOnly: true },
  ...
  const drawerContent = (
    ...
    >
      <div
        className="absolute inset-0 bg-[var(--color-bg)]/40 backdrop-blur-sm transition-opacity"
        onClick={handleClose}
        aria-hidden="true"
      />
