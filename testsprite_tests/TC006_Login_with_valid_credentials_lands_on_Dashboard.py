...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to http://localhost:4173/#/login and wait for the login page to render so the Login form can be interacted with.
        await page.goto("http://localhost:4173/#/login")
        
        # -> Click the 'Barbearia' card (element index 113) to proceed to the page that should contain the login form.
