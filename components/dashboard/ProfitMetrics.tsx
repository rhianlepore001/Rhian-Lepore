    ...
    return (
        <>
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
                ...
                {/* Card 1: Receita do Mês — sempre exibido, mas crescimento semanal só com dados */}
                <BrutalCard
                    ...
                    <div className="p-4 md:p-5 flex flex-col justify-between h-full bg-neutral-900/50">
                        <div className="flex justify-between items-start mb-2">
                            <div className="flex items-center gap-1">
                                <span className="text-xs md:text-sm font-mono uppercase text-text-secondary tracking-wider">Receita do Mês</span>
                                <InfoButton text="Valor total faturado no mês corrente." />
                            </div>
