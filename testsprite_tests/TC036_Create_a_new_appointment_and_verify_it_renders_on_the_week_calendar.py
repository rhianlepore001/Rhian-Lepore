...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Barbearia' selection card to enter the app (element index 116).
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div/div/button').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Fill the email (index 178) and password (index 184) fields, then click the ENTAR / Sign in button (index 198).
        frame = context.pages[-1]
        # Input text
        ...
        frame = context.pages[-1]
        assert await frame.locator("xpath=//*[contains(., 'New appointment')]").nth(0).is_visible(), "Expected 'New appointment' to be visible"
