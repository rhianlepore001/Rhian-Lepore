...
export const AgendaEmptySlotCell: React.FC<AgendaEmptySlotCellProps> = ({
  ...
  return (
    <button
      ...
      className={`group/slot relative flex-1 min-w-0 h-full min-h-[52px] border-r last:border-r-0 p-1 flex items-center justify-center
    ...
    >
      <span
        className="pointer-events-none flex items-center justify-center w-8 h-8 rounded-full
