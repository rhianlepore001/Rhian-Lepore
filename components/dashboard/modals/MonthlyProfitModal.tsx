                    ...
                    <div className="max-h-[50vh] overflow-y-auto custom-scrollbar space-y-2">
                        {history.map((item, idx) => (
                            <div
                                ...
                                className={`flex items-center justify-between p-4 rounded-xl border transition-colors ${idx === 0 ? `${colors.card} ${colors.border} ring-1 ring-[var(--color-input-border)]` : `${colors.inputBg} ${colors.border} hover:bg-[var(--color-card-hover)]`}`}
                            >
