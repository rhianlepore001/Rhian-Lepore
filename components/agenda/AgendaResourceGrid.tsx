              ...
              >
                ...
                {timeSlots.map((time) => {
                  ...
                  return (
                    <div
                      key={time}
                      className={`min-h-12 md:min-h-14 border-b ${colors.divider} last:border-b-0 px-1.5 py-1 flex flex-col gap-1`}
                    >
                      {cellApts.map((apt) => {
                        ...
                        return (
                          <button
                            ...
                            className={`agenda-event-chip w-full text-left rounded-lg border ${cardTokens} px-2.5 py-1.5 flex-1 min-h-0 flex flex-col justify-center gap-0.5 transition-shadow focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-theme-accent`}
                          >
                            <div className="flex items-start justify-between gap-1">
                              <h4 className={`text-xs font-bold break-words leading-snug ${colors.text}`}>{apt.clientName}</h4>
                            ...
                            <div className="flex items-start justify-between gap-1">
                              <span className={`text-xs break-words leading-snug ${isUnassigned ? 'text-[var(--color-danger)]' : colors.textMuted}`}>
                                {apt.service}
                              </span>
