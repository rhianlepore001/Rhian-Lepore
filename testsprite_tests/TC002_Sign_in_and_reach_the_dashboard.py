...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Barbearias' (barber) experience card to reveal the email/password login form.
        # Click the 'Barbearias' (barber) experience card to reveal the email/password login form.
        elem = page.locator("xpath=/html/body/div/div/div[3]/button/div/div").nth(0)
        await elem.wait_for(state="visible", timeout=10000)
        await elem.click()
        
        # -> Fill the email field with rleporesilva@gmail.com, fill the password with rhianlepore789, then click the Entrar na conta button to submit.
