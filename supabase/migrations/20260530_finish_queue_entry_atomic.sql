-- Fase 4: finalizacao atomica da fila digital.
-- Substitui o fluxo client-side que criava client, appointment, finance_record
-- e depois atualizava queue_entries em operacoes separadas.
...
BEGIN
  ...
  WHERE user_id::TEXT = v_auth_company_id
    AND phone = v_entry.client_phone
...
GRANT EXECUTE ON FUNCTION public.finish_queue_entry(
  UUID,
  TEXT,
  DECIMAL,
  UUID
